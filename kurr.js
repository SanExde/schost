...
kurr = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: from } : {})},message: {"extendedTextMessage": {"text": `HY : ${pushname}\n❀ RUNTIME : ${kyun(runtime)}`, 'title':'2', 'jpegThumbnail': fake}}}
        // Bot Status
...
if (!isCreator) throw  m.reply(`Lu Siapa Ajg`)
        ...
        axios.get(`https://LinkLogWhmLu/json-api/removeacct?api.version=1&username=${uname}`, { headers: { Authorization: "Basic " + Buffer.from("root:Pwroot lu").toString("base64") } })
        .then(e=>{if([1, "1"].includes(e.data?.metadata?.result)) m.reply(`𝐃𝐎𝐍𝐄 ✅ 𝐔𝐧𝐬𝐞𝐫 ${uname} 𝐓𝐄𝐋𝐀𝐇 𝐃𝐈 𝐓𝐄𝐑𝐌𝐈𝐍𝐓`); else {m.reply("error"); console.log(e.data)}})
        .catch(e=>{m.reply("error"); console.log(JSON.stringify(e, null, 2))})
      break
case 'listdomain': {
if(from != "120363045198440024@g.us") return m.reply("Mohon maff ya Bang . Nyewa bot ? 35k")
                anu = `𝐋𝐈𝐒𝐓 𝐃𝐎𝐌𝐀𝐈𝐍\n\n𝐊𝐋𝐈𝐂𝐊 𝐀𝐉𝐀 𝐃𝐈 𝐁𝐔𝐓𝐓𝐎𝐍 𝐃 𝐁𝐀𝐖𝐀𝐇 𝐘𝐎𝐎`
                    ...
                    templateMessage: {
                        hydratedTemplate: {
                            ...
                            hydratedButtons: [{
                                ...
                                quickReplyButton: {
                                    displayText: '❝listdomain1❞',
                                    id: 'listdomain1'
                                }
                            }, {
                                quickReplyButton: {
                                    displayText: '❝listdomain2❞',
                                    id: 'listdomain2'
                                }  
                            }, {
                                quickReplyButton: {
                                    displayText: '❝listdomain3❞',
                                    id: 'listdomain3'
                                }
                            }]
                        }
...
case 'addpack':
         if(from != "120363045198440024@g.us") return m.reply("Mohon maff ya Bang . Nyewa bot ? 35k")
        let sUser1 = "root";
        let sPass1 = "@@yosoka123@@";
        let serverName1 = "papernesia-vipp.vipdk.cf:2087";
